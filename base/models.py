...
class Site(models.Model):
    ...
    patente = models.CharField(max_length =15, verbose_name = "Patente",null = True, blank = True)
    ref = models.CharField(max_length =5, verbose_name = "Ref",unique = True)
    actif = models.BooleanField(default=True, verbose_name = "Actif")
    history = HistoricalRecords(table_name="base_site_history")
    societe_obj = models.ForeignKey(Societe, verbose_name = "Société",related_name="sites",on_delete=models.PROTECT , limit_choices_to={'actif': True} )
